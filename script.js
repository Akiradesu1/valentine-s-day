alert("My apologies for being late to Send you a website 😔 ");
alert("Website ng kinda not look good anyways");
alert("But hopefully you loved it TT");
...
const tontonGifs = [
  ...
  "https://media1.tenor.com/m/UiDAuObXq8gAAAAd/ayamai.giif",
...
yesBtn.addEventListener("click", () => {
  title.innerHTML = "Finally, You accepted 😭";
  btnContainer.classList.add("hidden");
  changeImage("yes");
  img.addEventListener("transitionend", () => {
    alert('ke mean mail oyy tahh ,click ok hv');
